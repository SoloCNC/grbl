...
/* The defaults.h file serves as a central default settings selector for different machine
  ...
  #define DEFAULT_X_BACKLASH                0.30    // mm
  #define DEFAULT_Y_BACKLASH                0.30    // mm
  #define DEFAULT_Z_BACKLASH                0.00    // mm
#endif

#ifdef WORKBEE_LINANW
  // Grbl default settings for test_machine_workbee_linanw.
  #define DEFAULT_X_STEPS_PER_MM 106.667
  #define DEFAULT_Y_STEPS_PER_MM 106.667
  #define DEFAULT_Z_STEPS_PER_MM 800.0
  #define DEFAULT_X_BACKLASH_MM 0.04
  #define DEFAULT_Y_BACKLASH_MM 0.04
  ...
  #define DEFAULT_X_MAX_TRAVEL 401.0 // mm NOTE: Must be a positive value.
  #define DEFAULT_Y_MAX_TRAVEL 211.0 // mm NOTE: Must be a positive value.
  #define DEFAULT_Z_MAX_TRAVEL 118.0 // mm NOTE: Must be a positive value.
